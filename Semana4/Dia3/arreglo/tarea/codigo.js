...
Mi QR para que me yapees tú
Te enseño mi Q, te enseño mi Q
Mi QR para que me yapees tú, tú tú.`,`Ese chico de ahí
...
Para a mi cu-, para a mi cu-, cuerpo bien hermoso
Déjame un ram-, déjame un ram-, ramo de flores
Para mi cu-, para mi cumpleaños`,`Te toco la trompeta (si señor)
...
Que rico, que rico se siente
Tener la trompeta en la boca (bis)`,`Vive la vida y no dejes que la vida te viva
...
mueve la cabeza
Mueve la cabeza o se pone tiesa
mueve la cabeza`,"Debes eleccionar una cancion"]
function mostrarCanciones(){
    ...
    if(eleccion === "mi-qr"){
        ...
        parrafo.textContent = Song[0];


    }else if(eleccion === "me-ah-rechazado" ){
        titulo.textContent = contenido;
        parrafo.textContent = Song[1];


    }else if(eleccion === "la-trompeta" ){
        titulo.textContent = contenido;
        parrafo.textContent = Song[2];


    }else if(eleccion === "vive-la-vida" ){
        titulo.textContent = contenido;
        parrafo.textContent = Song[3];


    }else{
        titulo.textContent = "";
        parrafo.textContent = Song[4];
    }
}